  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
    <div class="card mb-3" style="">
      <div class="card-header">
        <i class="fa fa-table"></i> <span class="ml-2">Categories</span>
        <button class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#addModal">Add Category</button>
      </div>
              ...
              @if(count($categories) > 0)
                @foreach($categories as $category)
                  <tr>
                    <td>{{ $category->name }}</td>
                    <td>
                      <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal{{ $category->id }}" title="Edit Branch"><i class="fa fa-fw fa-edit"></i>Edit</button>
                      <!-- Add Modal -->
                      ...
                      <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $category->id }}" title="Delete Branch"><i class="fa fa-fw fa-trash"></i>Delete</button>
                      <!-- Delete Modal-->
